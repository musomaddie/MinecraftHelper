...
class TestMoveNextCategory:
    ...
    def test_breaking_left(self, mock_redirect, mock_url_for):
    ...
    @patch(url_for_patch_str)
    @patch(redirect_patch_str)
    def test_none_left(self, mock_redirect, mock_url_for):
...
class TestEitherMoveNextCategoryOrRepeat:
    ...
    @patch(url_for_patch_str)
    @patch(redirect_patch_str)
    def test_move_next(self, mock_redirect, mock_url_for):
