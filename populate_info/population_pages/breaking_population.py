...
from populate_info.group_utils import (
    get_group_breaking_info, maybe_group_toggle_update_saved, maybe_write_category_to_group, auto_populate_values)
...
def breaking(item_name):
    ...
    if request.method == "GET":
        return render_template(
            ...
            group_info=auto_populate_values(
                breaking_json_to_html_ids(get_group_breaking_info(session[r.GROUP_NAME_SK], item_name)),
                session.get(r.USE_GROUP_VALUES_SK, False)),
